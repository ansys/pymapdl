...
class _MapdlCore(Commands):
    ...
    def load_array(self, name, array):
        ...
        *VREAD (p. 2066),ParR,Fname,Ext,--,Label,n1,n2,n3,NSKIP
    ...
    def load_table(self, name, array, var1="", var2="", var3="", csysid=""):
        ...
        if array.ndim == 2:
            self.dim(name, "TABLE", imax=array.shape[0]-1, jmax=array.shape[1], kmax="",
                     var1=var1, var2=var2, var3=var3, csysid=csysid)
        elif array.ndim == 3:
            self.dim(name, "TABLE", imax=array.shape[0]-1, jmax=array.shape[1], kmax=array.shape[2],
                     var1=var1, var2=var2, var3=var3, csysid=csysid)
        else:
            raise ValueError(
