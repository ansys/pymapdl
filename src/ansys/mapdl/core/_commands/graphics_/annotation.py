class Annotation:
    ...
    def slashline(self, x1="", y1="", x2="", y2="", **kwargs):
        ...
        The command is generated by the Graphical User Interface (GUI) and appears in the log file (`Job-name.LOG`) if annotation is used. It is not intended to be typed in directly in a Mechanical APDL session (although it can be included in an input file for batch input or for use with the `/INPUT` command).
