...
using :func:`convert_apdl_strings() <ansys.mapdl.core.convert.convert_apdl_strings>`:
...
.. code:: python
    ...
    N,,0,0,1
    FINISH"""
    pycode = convert_apdl_strings(apdl_string) # apdl_string can be also a list of strings.
