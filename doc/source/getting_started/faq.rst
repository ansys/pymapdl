...
If you find an issue, the first place to check for possible solutions is the :ref:`troubleshooting section <ref_troubleshooting>`.

If you do not find it there, the following place to check is the `GitHub repository <pymapdl_repo_>`_. You can use `the search box <pymapdl_search_issues_pr_>`_ to find related issues or pull requests.
