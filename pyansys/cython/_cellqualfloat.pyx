...
# Inline subfunctions
#==============================================================================
cdef inline float TripleProduct(float [3] ab, float [3] bc, float [3] cd):
    return ab[0] * (bc[1] * cd[2] - bc[2] * cd[1]) -\
           bc[0] * (ab[1] * cd[2] - ab[2] * cd[1]) +\
           cd[0] * (ab[1] * bc[2] - ab[2] * bc[1])


cdef inline float NormCalc(float [3] vec):
...
cdef inline float TetLinJac(long [::1] cellarr, int c, float [:, ::1] pts):
...
cdef inline float PyrLinJac(long [::1] cellarr, int c, float [:, ::1] pts):
...
cdef inline float WegLinJac(long [::1] cellarr, int c, float [:, ::1] pts):
...
cdef inline float HexLinJac(long [::1] cellarr, int c, float [:, ::1] pts):
...
#==============================================================================
cdef inline float TetQuadJac(long [::1] cellarr, int c, float [:, ::1] pts):
    """
    ...
    cdef float jac = TripleProduct(e1, e2, e0)/tnorm
...
cdef inline float PyrQuadJac(long [::1] cellarr, int c, float [:, ::1] pts):
    """
...
cdef inline float WegQuadJac(long [::1] cellarr, int c, float [:, ::1] pts):
    """
...
cdef inline float HexQuadJac(long [::1] cellarr, int c, float [:, ::1] pts):
    """
...
#==============================================================================
def CompScJac_quad(long [::1] cellarr, float [:, ::1] pts):
    """
    FUNCTION SIGNATURE
    CompScJac_quad(long [::1] cellarr, float [:, ::1] pts)
    ...
    pts (float [:, ::1])
        Float precision points accompaning cellarr
    ...
    cdef float [::1] jacs = np.empty(cellarr_sz, ctypes.c_float)
    cdef float jac, normjac, detjac, tnorm
    cdef int cnum = 0
    while c < cellarr_sz:
