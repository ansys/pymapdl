...
Often you may wish to view an area, or region, in
increased detail using a smaller element size. This
...
# need to specify an element type (we use SHELL181 here) and mesh our shape!
#
