...
result.plot_nodal_solution(2, title="Spot Weld: Displacement")
...
result.plot_nodal_stress(0, "Sz", title="Spot weld: Z stress")


# Get the principal nodal stress and plot the von Mises stress

nnum, pstress = result.principal_nodal_stress(0)
result.plot_principal_nodal_stress(0, "SEQV", title="Spot weld: von Mises stress")
