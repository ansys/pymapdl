...
project = 'ansys.mapdl'
copyright = '2020, Alex Kaszynski, Jorge Gil, & Frederic Thevenon'
author = 'Alex Kaszynski, Jorge Gil, & Frederic Thevenon'
...
latex_documents = [
    (master_doc, 'pyansys.tex', 'ansys.mapdl Documentation',
     'Alex Kaszynski, Jorge Gil, \\& Frederic Thevenon', 'manual'),
]
